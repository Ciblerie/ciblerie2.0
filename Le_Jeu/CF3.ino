...
void CF3(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGame3();}     
  if (partieEnCours==true){trtPartieEnCours3();} 
  if (partieFinie==true){trtPartieFinie3();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinie3(){    
    FinGame();   
